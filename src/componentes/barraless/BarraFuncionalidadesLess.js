    ...
    return (
        <div id="BarraFuncionalidadesLess">
          <div id='CaixaAzulLess'>
            <img src={image}></img>
            <div id="azulLess"><div onClick={()=> this.states("less")} id="PesquisaFuncionalidadesLess"><input id="inputPesquisaFuncionalidadesLess" onBlur={() => this.limpaCampo("inputPesquisaFuncionalidadesLess")}/><span id="pesquisaItens" class="material-icons">search</span></div></div>
          </div>
          <ul>          
